...
The application allows the user to enter a movie review and returns: the predicted sentiment label, the confidence score, and the probability for each class.  
